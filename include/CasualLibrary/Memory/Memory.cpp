...
[[nodiscard]] static std::string Memory::getLastErrorAsString(void) noexcept
{
...
[[nodiscard]] static std::string Memory::convertToString(char* a, int size) noexcept
{
    int i;
    std::string s = "";
    for (i = 0; i < size; i++) {
...
[[nodiscard]] static std::vector<int> Memory::patternToBytes(const char* pattern) noexcept 
{
