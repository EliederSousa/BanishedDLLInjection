...
namespace Memory {
	[[nodiscard]] static std::vector<int> patternToBytes(const char* pattern) noexcept;
	[[nodiscard]] static std::string getLastErrorAsString(void) noexcept;
    [[nodiscard]] static std::string convertToString(char* a, int size) noexcept;
